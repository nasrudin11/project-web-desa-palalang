...
@section('content')
    ...
    <!-- tampilan dekstop (untuk layar besar) -->
    <section class="login d-flex flex-column flex-md-row d-none d-md-flex" style="height: 90vh">
    ...
    <!-- tampilan kecil (untuk layar kecil) -->
    <div class="container my-3">
        <div class="card col-md-3 d-block d-md-none">
            <img src="img/login.png" class="img-fluid img-top" alt="Login" style="width: 60%; margin: 0 auto; display: block;">
            <div class="card-body">
                <div class="header">
                    <h1>Welcome Back</h1>
                    <p>Welcome back! Please enter your details</p>
