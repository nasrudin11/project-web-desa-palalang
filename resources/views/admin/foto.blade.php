                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-0 w-auto">
                            <label for="emailWithTitle" class="form-label">Fie Foto</label>
                            <input type="file" id="emailWithTitle" class="form-control"/>
                        </div>

                        <div class="mb-6">
                            <label for="dobWithTitle" class="form-label">Deskripsi Foto</label>
                            <textarea id="dobWithTitle" class="form-control" placeholder="Enter Name"></textarea>
                        </div>
                      </div>
