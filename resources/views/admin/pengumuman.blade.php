                ...
                <div class="modal fade" id="tambahModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="/store-pengumuman" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="judul_publikasi" class="form-label">Judul Pengumuman</label>
                                        <input type="text" id="judul_publikasi" name="judul_publikasi" class="form-control @error('judul_publikasi') is-invalid @enderror" value="{{ old('judul_publikasi') }}" placeholder="Masukkan Judul pengumuman">
                                    ...
                                    <div class="mb-3">
                                        <label for="foto_publikasi" class="form-label">foto Pengumuman</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="deskripsi_publikasi" class="form-label">Deskripsi Pengumuman</label>
                                ...
                                <input type="hidden" name="jenis_publikasi" value="pengumuman">
        ...
        <div class="modal fade" id="editModal{{ $item->id_publikasi }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="/edit-pengumuman/{{ $item->id_publikasi }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="mb-2">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/delete-pengumuman/{{ $item->id_publikasi }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <div class="modal-footer">
